...
public class Card {
    ...
    public boolean isSpell() {
        return !isMinion() && !isWeapon;
    }

    public void appendSpellText(Context context, SpannableStringBuilder flagBuilder, boolean isBattlecry){
    ...
    public View createView(Context context, ViewGroup root, boolean attach, int spellDamageBonus){
        View v;
        if(isMinion()){
            v = LayoutInflater.from(context).inflate(R.layout.minion_card, root, attach);
        } else {
            v = LayoutInflater.from(context).inflate(R.layout.spell_card, root, attach);
        }
        ...
        appendSpellText(context, flagBuilder, isMinion());
